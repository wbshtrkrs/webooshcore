<!-- plugins:css -->
<link rel="stylesheet" href="{{ asset('/assets/weboosh/webooshcore/vendors/iconfonts/mdi/css/materialdesignicons.min.css') }}">
<link rel="stylesheet" href="{{ asset('/assets/weboosh/webooshcore/vendors/iconfonts/puse-icons-feather/feather.css') }}">
<link rel="stylesheet" href="{{ asset('/assets/weboosh/webooshcore/vendors/css/vendor.bundle.base.css') }}">
<link rel="stylesheet" href="{{ asset('/assets/weboosh/webooshcore/vendors/css/vendor.bundle.addons.css') }}">
<!-- endinject -->
<!-- plugin css for this page -->
<link rel="stylesheet" href="{{ asset('/assets/weboosh/webooshcore/vendors/iconfonts/font-awesome/css/font-awesome.min.css') }}">
